  ...
  Toronto: [
    {
      ...
      blocks: [],
      lastActivity: 'Approved',
      lastActivityDate: 'Jan 15, 2025',
      daysInState: 22,
      assignee: { name: 'Priya Sharma', initials: 'PS', color: 'bg-green-500' },
      formTitle: 'Preliminary Review Request for Business Licence',
      formCode: 'Form TML-100',
      formUrl: 'https://www.toronto.ca/wp-content/uploads/2023/09/959a-14-0048-Preliminary-Review-Request-for-Business-License.pdf',
    },
    {
      id: 'tor-2',
      ...
      order: 2,
      blocks: [],
      lastActivity: 'Ready to fill — form auto-populated',
      lastActivityDate: new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }),
      daysInState: 3,
      priority: 'high',
      assignee: { name: 'Priya Sharma', initials: 'PS', color: 'bg-purple-500' },
      formTitle: 'Sidewalk Café Permit Application',
      formCode: 'Form R57',
      formUrl: '/api/fill-pdf?form=sidewalk-cafe',
    },
    {
      id: 'tor-3',
    ...
    },
    {
      ...
      status: 'not-started',
      order: 4,
      blockedBy: 'Sidewalk Café Permit',
      blocks: ['Sign Permit'],
      lastActivity: 'Blocked',
      lastActivityDate: new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }),
      daysInState: 0,
      formTitle: 'Application for a Permit to Construct or Demolish',
      formCode: 'Form 14-0094',
      formUrl: 'https://www.toronto.ca/wp-content/uploads/2025/10/94e5-14-0094-Final-Application-for-a-Permit-to-Construct-or-Demolish.pdf',
    },
    {
      id: 'tor-5',
      name: 'Sign Permit',
      ...
      status: 'not-started',
      order: 5,
      blockedBy: 'Building Permit',
      blocks: [],
      lastActivity: 'Blocked',
      lastActivityDate: new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }),
      daysInState: 0,
      formTitle: 'First Party Sign Permit Application',
      formCode: 'Form 14-0037',
      formUrl: 'https://www.toronto.ca/wp-content/uploads/2023/09/95b5-14-0037-First-Party-Sign-Permit.pdf',
    },
  ],
  default: [
    {
