...
class ContextStorage {
  ...
  // Yes/No question matching based on business context
  matchYesNoQuestion(questionText, permitContext) {
    const q = questionText.toLowerCase()
    
    // Check if permit data suggests answer
    if (permitContext) {
      // Example: "Do you serve alcohol?" → check if liquor license exists
      ...
      // Example: "Do you have outdoor seating?" → check if patio permit exists
